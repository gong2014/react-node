...
test('renders input and buttons', () => {
  render(<CreateItem handleAdd={jest.fn()} description="" setDescription={jest.fn()} />);
...
test('allows user to input text', () => {
  ...
  render(<CreateItem handleAdd={jest.fn()} description="" setDescription={setDescription} />);
...
test('clears input when clear button is clicked', () => {
  ...
  render(<CreateItem handleAdd={jest.fn()} description="New Todo Item" setDescription={setDescription} />);
